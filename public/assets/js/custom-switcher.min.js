...
function ltrFn() {
    ...
    if(!document.querySelector("#style").href.includes('bootstrap.min.css')){
        document.querySelector("#style")?.setAttribute("href", "../assets/libs/bootstrap/dist/css/bootstrap.min.css");
    }
...
function rtlFn() {
    ...
    document.querySelector("#style")?.setAttribute("href", "/assets/libs/bootstrap/dist/css/bootstrap.rtl.min.css");
    checkOptions();
}
